...
<body>
	...
	<?php if (isset($basic)) { ?>
		...
		<div>
			<h1>
				Welcome to the world!, <strong><?php echo he(idx($basic, 'name')); ?>
				</strong>
			</h1>
			<p class="tagline">
				This is your app <a href="<?php echo he(idx($app_info, 'link'));?>"
					target="_top"><?php echo he($app_name); ?> </a>
			</p>

			<div id="share-app">
				<p>Share your app:</p>
				<ul>
					<li><a href="#" class="facebook-button" id="postToWall"
						data-url="<?php echo AppInfo::getUrl(); ?>"> <span class="plus">Post
								to Wall</span> </a>
					</li>
					<li><a href="#" class="facebook-button speech-bubble"
						id="sendToFriends" data-url="<?php echo AppInfo::getUrl(); ?>"> <span
							class="speech-bubble">Send Message</span> </a>
					</li>
					<li><a href="#" class="facebook-button apprequests"
						id="sendRequest" data-message="Test this awesome app"> <span
							class="apprequests">Send Requests</span> </a>
					</li>
				</ul>
			</div>
		</div>
	...
	<section id="samples" class="clearfix">
		...
		<div class="list">
			...
			foreach ($friends as $friend) {
				...
				?>
				<li><a href="https://www.facebook.com/<?php echo he($id); ?>"
					target="_top"> <img
						src="https://graph.facebook.com/<?php echo he($id) ?>/picture?type=square"
						alt="<?php echo he($name); ?>"> <?php echo he($name); ?> </a>
				</li>
				<?php
			}
			?>
		...
		<div class="list">
			...
			foreach ($likes as $like) {
				...
				<li><a href="https://www.facebook.com/<?php echo he($id); ?>"
					target="_top"> <img
						src="https://graph.facebook.com/<?php echo he($id) ?>/picture?type=square"
						alt="<?php echo he($item); ?>"> <?php echo he($item); ?> </a>
				</li>
				<?php
			}
			?>
		...
		<div class="card-image" style="background: url(<?php echo $card_image_url;?>) no-repeat">
			<div class="card-template">
				<section class="card-sect-top">
					<img class="card-grade" /> <img class="card-trigger" />
				</section>
				<section class="card-sect-body">
					<img class="card-shield"
				...
				<section class="card-sect-ability">
					...
					<p class="card-ability">Auto : [Choose 1 Grade 3 Kagero from your
						hand and discard it] When this Unit attacks, you may pay the cost.
						If so, for that Battle, this unit gains +10000 Power.</p>
				</section>
				<section class="card-sect-title">
				...
				<section class="card-sect-footer">
					<span class="card-artist">Kei Studio</span>
				</section>
			</div>
		</div>
	</section>
	<section class="editor">
		...
		<form method="post" enctype="multipart/form-data" id="vanguardEditor"
			...
			<ul>
				...
				<li><label for="comment">Comment :</label> <input type="text" name="comment"
					id="comment" value='<?php echo $comment_val?>' />
				</li>
				<li><label for="clan">Clan :</label> <input type="text" name="clan" id="clan"
					value='<?php echo $clan_val?>' />
				</li>
				<li><label for="race">Race :</label> <input type="text" name="race" id="race"
					value='<?php echo $race_val?>' />
				</li>
				...
				<li>
					...
					<a href="#"><img src="https://dl.dropbox.com/u/4302206/vanguardcardmaker/images/card/ability/meaw.png"/></a>
					<a href="#"><img src="https://dl.dropbox.com/u/4302206/vanguardcardmaker/images/card/ability/ninja.png"/></a>
					<a href="#"><img src="https://dl.dropbox.com/u/4302206/vanguardcardmaker/images/card/ability/omg.png"/></a>
					<a href="#"><img src="https://dl.dropbox.com/u/4302206/vanguardcardmaker/images/card/ability/sick.png"/></a>
					<a href="#"><img src="https://dl.dropbox.com/u/4302206/vanguardcardmaker/images/card/ability/slow.png"/></a>
					<div id="ability_text" contenteditable="true"></div> 
					<!-- <textarea id="ability_text" rows="5" cols="30" style="resize: none;" name="ability">					
					</textarea> -->
				</li>
